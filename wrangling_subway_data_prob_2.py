...
def avg_weekend_temperature(filename):
   ...
   # weather_data['weekday'] = weather_data['date'].dt.weekday_name
    #print(weather_data['weekday'])
    #q = "SELECT AVG(cast (meantempi as integer)) from weather_data where weekday = 'Saturday' or weekday = 'Sunday'"
